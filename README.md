...
```scala
libraryDependencies += "io.github.alixba" %% "nats-scala-core" % "0.0.8"
```
...
override def mvnDeps: Simple[Seq[Dep]] = Seq(
  mvn"io.github.alixba::nats-scala-core:0.0.8"
)
```
...
libraryDependencies += "io.github.alixba" %% "nats-scala-otel" % "0.0.8"
```
...
override def mvnDeps: Simple[Seq[Dep]] = Seq(
  mvn"io.github.alixba::nats-scala-otel:0.0.8"
)
```
...
```scala
libraryDependencies += "io.github.alixba" %% "nats-scala-extra" % "0.0.8"
```
...
```scala
override def mvnDeps: Simple[Seq[Dep]] = Seq(
  mvn"io.github.alixba::nats-scala-extra:0.0.8"
)
```
